...
exports.getToken = function (req, res) {
	...
	res.cookie(exports.XSRF_COOKIE_KEY, res.locals[exports.LOCAL_VALUE], { secure: true, httpOnly: true }); //CET-4079
...
exports.requestToken = function (req) {
	...
	} else {// added for CET-4079
		return getCookieValue(req.headers.cookie, exports.XSRF_COOKIE_KEY);
	}
};
/**
 * added for CET-4079
 * Find the cookie @param cookieToFind from @param cookies and return the value of the cookieToFind
 * @param {*} cookies 
 * @param {*} cookieToFind 
 * @returns 
 */
function getCookieValue(cookies, cookieToFind) {
